...
export const notFoundPageData: PageData = {
    ...
    filePath: "",
    frontmatter: { layout: "page", sidebar: false },
    headers: [],
    isNotFound: true,
    lastUpdated: 0,
    relativePath: "404.md"
...
function hasTag(head: Array<HeadConfig>, tag: HeadConfig) {
...
export function mergeHead(prev: Array<HeadConfig>, curr: Array<HeadConfig>) {
